output "windows_function_app_slots_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.id }
}
output "windows_function_app_slots_app_settings" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.app_settings }
}
output "windows_function_app_slots_auth_settings" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.auth_settings }
  sensitive   = true
}
output "windows_function_app_slots_auth_settings_v2" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.auth_settings_v2 }
}
output "windows_function_app_slots_backup" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.backup }
  sensitive   = true
}
output "windows_function_app_slots_builtin_logging_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.builtin_logging_enabled }
}
output "windows_function_app_slots_client_certificate_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.client_certificate_enabled }
}
output "windows_function_app_slots_client_certificate_exclusion_paths" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.client_certificate_exclusion_paths }
}
output "windows_function_app_slots_client_certificate_mode" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.client_certificate_mode }
}
output "windows_function_app_slots_connection_string" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.connection_string }
  sensitive   = true
}
output "windows_function_app_slots_content_share_force_disabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.content_share_force_disabled }
}
output "windows_function_app_slots_custom_domain_verification_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.custom_domain_verification_id }
  sensitive   = true
}
output "windows_function_app_slots_daily_memory_time_quota" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.daily_memory_time_quota }
}
output "windows_function_app_slots_default_hostname" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.default_hostname }
}
output "windows_function_app_slots_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.enabled }
}
output "windows_function_app_slots_ftp_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.ftp_publish_basic_authentication_enabled }
}
output "windows_function_app_slots_function_app_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.function_app_id }
}
output "windows_function_app_slots_functions_extension_version" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.functions_extension_version }
}
output "windows_function_app_slots_hosting_environment_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.hosting_environment_id }
}
output "windows_function_app_slots_https_only" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.https_only }
}
output "windows_function_app_slots_identity" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.identity }
}
output "windows_function_app_slots_key_vault_reference_identity_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.key_vault_reference_identity_id }
}
output "windows_function_app_slots_kind" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.kind }
}
output "windows_function_app_slots_name" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.name }
}
output "windows_function_app_slots_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.outbound_ip_address_list }
}
output "windows_function_app_slots_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.outbound_ip_addresses }
}
output "windows_function_app_slots_possible_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.possible_outbound_ip_address_list }
}
output "windows_function_app_slots_possible_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.possible_outbound_ip_addresses }
}
output "windows_function_app_slots_public_network_access_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.public_network_access_enabled }
}
output "windows_function_app_slots_service_plan_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.service_plan_id }
}
output "windows_function_app_slots_site_config" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.site_config }
  sensitive   = true
}
output "windows_function_app_slots_site_credential" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.site_credential }
  sensitive   = true
}
output "windows_function_app_slots_storage_account" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.storage_account }
  sensitive   = true
}
output "windows_function_app_slots_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.storage_account_access_key }
  sensitive   = true
}
output "windows_function_app_slots_storage_account_name" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.storage_account_name }
}
output "windows_function_app_slots_storage_key_vault_secret_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.storage_key_vault_secret_id }
}
output "windows_function_app_slots_storage_uses_managed_identity" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.storage_uses_managed_identity }
}
output "windows_function_app_slots_tags" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.tags }
}
output "windows_function_app_slots_virtual_network_backup_restore_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.virtual_network_backup_restore_enabled }
}
output "windows_function_app_slots_virtual_network_subnet_id" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.virtual_network_subnet_id }
}
output "windows_function_app_slots_vnet_image_pull_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.vnet_image_pull_enabled }
}
output "windows_function_app_slots_webdeploy_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_windows_function_app_slot.windows_function_app_slots : k => v.webdeploy_publish_basic_authentication_enabled }
}
